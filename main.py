...
def get_question(id,token):
    ...
    #处理得到的received
    for a in res:
        solve_question(a,token)

def solve_question(ans,token):
    headers = {
        "Referer": "http://10.22.192.38:9092",
        'X-Access-Token': token
    }
...
def main():
    ...
    types=input("管院等5章节课程同学请输入0，其它学院等7章节课程同学请输入1:")
...
#获取课程信息ID，（纯手打，原网页好像用js刷新列表，不好爬取）不会JavaScript是我的败笔
    ...
    urls_10 = ["1823160098319699970","1812001903719178241","1812002182158049282","1812002376303992833","1812002589315915777","1812002830790385666","1812003016094736386","1812003162782130177","1812003273268486146","1812003581604356098","1812003717558525954","1812003845652570113","1812003961130147841","1812004167708008450","1812004352978804737","1812004502467993602"]
    urls_11 = ["1827980030299537410","1812004623993757697","1812004749810294786","1812005014382796802"]
    urls_4=["1822876505978638338","1811971453739032578","1811971579874336769","1814220927052005378","1811971695377080322","1811971819893383170","1811971950877302786"]
    ...
    match types:
        case 0:
            urls_lists = [urls_1, urls_2, urls_3, urls_10, urls_11]
        case 1:
            urls_lists = [urls_1, urls_2, urls_3, urls_4, urls_7, urls_10, urls_11]
        case _:
            urls_lists = [urls_1, urls_2, urls_3, urls_4, urls_7, urls_10, urls_11]
