...
#获取课程信息ID，（纯手打，原网页好像用js刷新列表，不好爬取）不会JavaScript是我的败笔
    ...
    match types:
        ...
        case 1:
            ...
            urls_lists = [urls_1, urls_2, urls_3, urls_4_B, urls_7, urls_10, urls_11]
        case 2:
            print("材料学院等A类[11章节课程]已加载")
            urls_lists = [urls_1, urls_2, urls_3, urls_4_B, urls_4_A,urls_6,urls_7, urls_8,urls_9,urls_10, urls_11]
        case _:
            print("输入错误。")
            exit()
    threads=[]
